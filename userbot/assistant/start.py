...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("بوتات المطور 🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/engineering_electrical9/719?comment=8")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="**بوتات تابعة للمطور 🧸♥️**.",
            buttons=[
                [Button.url("بوت  pdf 📕", "https://t.me/i2pdfbot")],
                [Button.url(" قناة المساعدة ❓", "https://t.me/engineering_electrical9")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @ta_ja199", alert=True)
