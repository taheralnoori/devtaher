...
def main_menu():
    text = f"**- [سـورس جـيبثون](https://t.me/ta_ja199)\
        \n المسـاعد\
        \n\
        \n◽ جيـبثون لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("Jmthon"):
            buttons = [
                (
                    ...
                    Button.url(" قنـاة البوت", "https://t.me/engineering_electrical9/719?comment=8"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("المطور البوت", "https://t.me/ta_ja199"),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/engineering_electrical9",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        text, msg_entities = await event.client._parse_message_text(
            "**[بـوت جيـبثون 🧸♥](https://t.me/engineering_electrical9)**\
            \n\
            \n❤️  انا بـوت بسـيط يدخـل الـى حسـابك لجعـلك تتحـكم به معـ اوامـر معينـة.\
            \n\
            \n**المطور البوت : @ta_ja199 ,\
            \n🐾 تعال الـى [قناة الدعم](https://t.me/engineering_electrical9)!**",
            "md",
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
